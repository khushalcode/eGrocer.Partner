class SellerOrderReturnRequest {
  String? status;
  String? message;
  String? total;
  List<SellerOrderReturnRequestData>? data;

  SellerOrderReturnRequest({this.status, this.message, this.total, this.data});

  SellerOrderReturnRequest.fromJson(Map<String, dynamic> json) {
    status = json['status'].toString();
    message = json['message'];
    total = json['total'].toString();
    if (json['data'] != null) {
      data = <SellerOrderReturnRequestData>[];
      json['data'].forEach((v) {
        data!.add(new SellerOrderReturnRequestData.fromJson(v));
      });
    }
  }
...
class SellerOrderReturnRequestData {
  String? id;
  String? userId;
  ...
  SellerOrderReturnRequestData.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
